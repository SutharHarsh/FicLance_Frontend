...
const FreelanceCTA = () => {
  ...
  return (
    <section className="py-20 mx-4 sm:mx-12 rounded-2xl bg-[#FFA21F] text-[#7529c6]">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-xl mb-10 max-w-2xl mx-auto text-[#1E1E1E]/80">
          Learn through real projects, grow your confidence, and build a
          portfolio that speaks for your skills.
        </p>
