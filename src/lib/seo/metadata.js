...
export const brandAssets = {
  ...
  ogImage: "/OG%20image%20(2).png", // Properly encoded filename
  favicon: "/favicon.ico",
...
export function generateMetadata({
  ...
  // FORCE build-wide static OG image for all paths as requested
  // This ensures the custom project/portfolio images don't override the primary branding
  const pageImage = `${siteConfig.domain}${brandAssets.ogImage}`;
  const allKeywords = [
    ...new Set([
      ...defaultKeywords,
